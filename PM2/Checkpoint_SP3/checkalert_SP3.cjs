 ...
 */
const chatId = process.env.WHATSAPP_GRUPO_SP3; // Grupo do cliente para envio de alertas
 ...
 */
let cacheFile = path.join(__dirname, 'cache_SP3.json'); // Nome específico do cache
